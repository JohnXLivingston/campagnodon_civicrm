 ...
 * (GenCodeChecksum:6e96fa7a7e8cbffa25a9ea2ba8cfc044)
 */
...
class CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction extends CRM_Core_DAO {
  ...
  /**
   * Optional parent id for this CampagnodonTransaction. Used for recurring transaction.
   *
   * @var int|string
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * The operation type given by the origin system. Example: donation, membership, ... Can be any string, only used to filter transactions.
   *
   * @var string
   *   (SQL type: varchar(255))
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * The datetime to use as receive_date for contributions.
   *
   * @var string
   *   (SQL type: datetime)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * The recurring status of the transaction (if this is a recurring transaction).
   *
   * @var string
   *   (SQL type: varchar(20))
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * The url to the original transaction.
   *
   * @var string|null
   *   (SQL type: varchar(255))
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * True if transaction information were merged into the contact
   *
   * @var bool|string
   *   (SQL type: tinyint)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * True if personnal information were deleted from the transaction
   *
   * @var bool|string
   *   (SQL type: tinyint)
   *   Note that values will be retrieved from the database as a string.
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'parent_id', 'civicrm_campagnodon_transaction', 'id');
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'parent_id' => [
          'name' => 'parent_id',
          'type' => CRM_Utils_Type::T_INT,
          'title' => E::ts('Parent CampagnodonTransaction ID'),
          'description' => E::ts('Optional parent id for this CampagnodonTransaction. Used for recurring transaction.'),
          'required' => FALSE,
          'where' => 'civicrm_campagnodon_transaction.parent_id',
          'default' => NULL,
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
        ...
        'operation_type' => [
          'name' => 'operation_type',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Operation Type'),
          'description' => E::ts('The operation type given by the origin system. Example: donation, membership, ... Can be any string, only used to filter transactions.'),
          'required' => TRUE,
          'maxlength' => 255,
          'size' => 30,
          'where' => 'civicrm_campagnodon_transaction.operation_type',
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
          'localizable' => 0,
        ...
        'contribution_date' => [
          ...
          'description' => E::ts('The datetime to use as receive_date for contributions.'),
          'required' => TRUE,
          'where' => 'civicrm_campagnodon_transaction.contribution_date',
          'default' => 'NOW()',
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
        ...
        'recurring_status' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Recurring Status'),
          'description' => E::ts('The recurring status of the transaction (if this is a recurring transaction).'),
          'required' => FALSE,
          'maxlength' => 20,
          'size' => CRM_Utils_Type::MEDIUM,
          'where' => 'civicrm_campagnodon_transaction.recurring_status',
          'default' => NULL,
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
          ...
          'pseudoconstant' => [
            'callback' => 'CRM_CampagnodonCivicrm_BAO_CampagnodonTransaction::recurringStatusTables',
          ],
          'add' => NULL,
        ],
        'tax_receipt' => [
        ...
        'transaction_url' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Transaction Url'),
          'description' => E::ts('The url to the original transaction.'),
          'maxlength' => 255,
          'size' => 60,
          'where' => 'civicrm_campagnodon_transaction.transaction_url',
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
          'localizable' => 0,
          'html' => [
            'type' => 'Text',
            'label' => E::ts("Original transaction url"),
          ],
          'add' => NULL,
        ],
        ...
        'source' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Source'),
          'description' => E::ts('Origin of this Transaction.'),
          'required' => FALSE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'where' => 'civicrm_campagnodon_transaction.source',
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
          'localizable' => 0,
      ...
      delivery, etc.).'),
        ...
        'supplemental_address_1' => [
          ...
          'size' => CRM_Utils_Type::HUGE,
          'import' => TRUE,
          'where' => 'civicrm_campagnodon_transaction.supplemental_address_1',
          'export' => TRUE,
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
        ...
        'supplemental_address_2' => [
          ...
          'description' => E::ts('Supplemental Address Information, Line 2'),
          'maxlength' => 96,
          'size' => CRM_Utils_Type::HUGE,
          'import' => TRUE,
          'where' => 'civicrm_campagnodon_transaction.supplemental_address_2',
          'export' => TRUE,
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
        ...
        'merged' => [
          ...
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => E::ts('Merged'),
          'description' => E::ts('True if transaction information were merged into the contact'),
          'required' => TRUE,
          'where' => 'civicrm_campagnodon_transaction.merged',
          'default' => 'false',
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
        ...
        'cleaned' => [
          ...
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => E::ts('Cleaned'),
          'description' => E::ts('True if personnal information were deleted from the transaction'),
          'required' => TRUE,
          'where' => 'civicrm_campagnodon_transaction.cleaned',
          'default' => 'false',
          'table_name' => 'civicrm_campagnodon_transaction',
          'entity' => 'CampagnodonTransaction',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransaction',
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      ...
      'index_operation_type' => [
        'name' => 'index_operation_type',
        'field' => [
          0 => 'operation_type',
        ],
        'localizable' => FALSE,
        'sig' => 'civicrm_campagnodon_transaction::0::operation_type',
      ],
      'start_date' => [
        'name' => 'start_date',
        'field' => [
      ...
      'contribution_date' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_campagnodon_transaction::0::contribution_date',
      ],
      'cleaned_start_date_idx' => [
        'name' => 'cleaned_start_date_idx',
        'field' => [
          0 => 'cleaned',
          1 => 'start_date',
        ],
        'localizable' => FALSE,
        'sig' => 'civicrm_campagnodon_transaction::0::cleaned::start_date',
      ],
    ];
