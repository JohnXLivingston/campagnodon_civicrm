 ...
 * (GenCodeChecksum:28c8788b1a7aa6f6f40a00439761a198)
 */
...
class CRM_CampagnodonCivicrm_DAO_CampagnodonTransactionLink extends CRM_Core_DAO {
  ...
  /**
   * Only when entity_table='group' or 'contact'. If true, the contact will be added in group only when transaction is complete.
   *
  ...
  /**
   * Only when entity_table='contribution'. FK to Membership Type.
   *
   * @var int|string
   *   (SQL type: int unsigned)
   *   Note that values will be retrieved from the database as a string.
  ...
  /**
   * Only when entity_table='contribution' and membership_type_id not null. True when the membership was added (to prevent multiple membership in case of multiple sync).
   *
   * @var bool|string|null
   *   (SQL type: tinyint)
   *   Note that values will be retrieved from the database as a string.
   */
  public $membership_added;

  /**
   * An opt-in action to do on the contact.
   *
   * @var string|null
   *   (SQL type: varchar(25))
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'on_complete' => [
          ...
          'description' => E::ts('Only when entity_table=\'group\' or \'contact\'. If true, the contact will be added in group only when transaction is complete.'),
        ...
        'membership_type_id' => [
          ...
          'description' => E::ts('Only when entity_table=\'contribution\'. FK to Membership Type.'),
          'required' => FALSE,
        ...
        'membership_added' => [
          'name' => 'membership_added',
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => E::ts('Membership added'),
          'description' => E::ts('Only when entity_table=\'contribution\' and membership_type_id not null. True when the membership was added (to prevent multiple membership in case of multiple sync).'),
          'where' => 'civicrm_campagnodon_transaction_link.membership_added',
          'default' => 'false',
          'table_name' => 'civicrm_campagnodon_transaction_link',
          'entity' => 'CampagnodonTransactionLink',
          'bao' => 'CRM_CampagnodonCivicrm_DAO_CampagnodonTransactionLink',
        ...
        'opt_in' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Opt-in'),
          'description' => E::ts('An opt-in action to do on the contact.'),
          'maxlength' => 25,
