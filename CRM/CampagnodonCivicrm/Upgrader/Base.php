 ...
 */
class CRM_CampagnodonCivicrm_Upgrader_Base {

  /**
   * @var CRM_CampagnodonCivicrm_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_CampagnodonCivicrm_Upgrader(
        'campagnodon_civicrm',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_CampagnodonCivicrm_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_CampagnodonCivicrm_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
