...
CREATE TABLE `civicrm_campagnodon_transaction` (
  ...
  `contribution_date` datetime NOT NULL DEFAULT NOW() COMMENT 'The datetime to use as receive_date for contributions.',
  ...
  INDEX `contribution_date`(contribution_date),
